...
class FamilyService {
    ...
    func createFamilyMember(username: String, jwtToken: String, userId: String, relationship: String, name : String, files: [MediaFile], completion: @escaping (Result<addUpdateDeleteFamilyMemberResponse, Error>) -> Void){
        ...
        NetworkManager.shared.multipartRequest(url: "/family/add", method: "post", params: params, files: files){data,response,error in
    ...
    func updateFamilyMember(memberId: String, username: String, jwtToken: String, userId: String, relationship: String, name : String, files: [MediaFile], completion: @escaping (Result<addUpdateDeleteFamilyMemberResponse, Error>) -> Void){
        ...
        NetworkManager.shared.multipartRequest(url: "/family/update", method: "put", params: params, files: files){data,response,error in
    ...
    func deleteFamilyMember(username: String, jwtToken: String, userId: String, memberId: String, completion: @escaping (Result<addUpdateDeleteFamilyMemberResponse, Error>) -> Void){
        ...
        NetworkManager.shared.request(url: "/family/delete", method: "delete", body: credentials) {
    ...
    func fetchAllFamilyMembersLogs(username: String, jwtToken: String, userId: String, completion: @escaping (Result<FamilyMemberResponse, Error>) -> Void){
        ...
        NetworkManager.shared.request(url: urlString, method: "get") { data, response, error in
            ...
            // Handle Network/Transport Errors
            if let error = error {
                print("Network error on /logs/family_member/fetch_all: \(error)")
                completion(.failure(error))
                return
            }
