...
//                    authViewModelObject.navPath.append(AuthRoute.newPassword)               } label: {
//                    Text("Next")
//                        .bold()
//                        .font(.headline)
...
//                .padding(.horizontal, 30)
                ...
                PrimaryButton(buttonText: "Next", buttonTextColor: .black, buttonColor: "custom_yellow", action: {
                    ...
                    if authViewModelObject.username == "" || authViewModelObject.security_answer == "" {
                        messageOfError = "Please fill in all required fields."
                        conditionOfError = true
                        return
                    }
                    authViewModelObject.navPath.append(AuthRoute.newPassword)
